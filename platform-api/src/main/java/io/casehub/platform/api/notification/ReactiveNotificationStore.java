...
/**
 * Reactive notification persistence SPI. Implementations must provide both this interface
 * and {@link NotificationStore} natively — no bridge pattern.
 *
...
public interface ReactiveNotificationStore {
     ...
     * @return Uni emitting the persisted notification with generated id and timestamps
     */
     ...
     * @return Uni emitting list of persisted notifications in input order
     */
     ...
     * @return Uni emitting page of notifications with optional next cursor
     */
     ...
     * @return Uni emitting count of {@link NotificationStatus#UNREAD} notifications
     */
     ...
     * @return Uni emitting updated notification with new status and {@code readAt}, or empty if not found/unauthorized
     */
     ...
     * @param userId    notification owner (authorization check)
     * @param tenancyId tenant isolation (authorization check)
     * @return Uni emitting updated notification with new status and {@code dismissedAt}, or empty if not found/unauthorized
     */
     ...
     * @param tenancyId tenant isolation
     * @return Uni emitting count of notifications marked as read
     */
