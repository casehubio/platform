...
Not closed here: Graphiti adapter (#34 — later closed in C16), Mem0 `storeAll()` batch (#70 — deferred pending upstream batch endpoint; #69 superseded). Multi-turn `AgentSession` (#58) shipped in C20.
