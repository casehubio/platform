...
public class NoOpCaseMemoryStore implements GraphCaseMemoryStore {
    ...
    @Override public void eraseById(final String memoryId, final String tenantId) {}
    @Override public void eraseEntity(final String entityId, final String tenantId) {}
