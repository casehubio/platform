...
public record ModelQuery(
    ...
    public static final class Builder {
        ...
        public Builder tier(ModelTier tier)  {
                                                 this.tier = tier;
                                                 return this;
                                             }
        ...
        public Builder locality(ModelLocality locality)           {
                                                                      this.locality = locality;
                                                                      return this;
                                                                  }

        public Builder maxCostTier(CostTier maxCostTier)          {
                                                                      this.maxCostTier = maxCostTier;
                                                                      return this;
                                                                  }
        ...
        public Builder minMaxOutput(Integer minMaxOutput)         {
                                                                      this.minMaxOutput = minMaxOutput;
                                                                      return this;
                                                                  }

        public Builder preferVendor(String preferVendor)          {
